...
$sel_query="Select * from Book ORDER BY isbn desc;";
...
<td align="center">
<a href="bookupdate.php?isbn=<?php echo $row["ISBN"]; ?> "> Update</a>
</td>
<td align="center">
<a href="bookdelete.php?isbn=<?php echo $row["ISBN"]; ?>"> Delete</a>
</td>
</tr>
<?php $count++; } ?>
</tbody>
